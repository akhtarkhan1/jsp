    ...
    <body>
           <%@ include file="admindept.jsp" %>
            ...
            <center>
                ...
                <form action="trainingDao.jsp" method="POST" onsubmit="return validate2();"></br></br>
                    <div align="center">
    	...
    	<input type="reset" value="Clear">    
                    ...
                    <a href="crewinfomenuadmin.jsp"><img src="images\v2.png" border="0" alt="" width="80" height="40" align="left" /></a>
                    <a href="TDT.jsp"><img src="images\v11.png" border="0" alt="" width="80" height="40"  align="right"/></a>
                    <br><br><br>
                     <center>
                         <b><a href="updatetraining.jsp">Update Record</a></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <b><a href="deletetraining.jsp">Delete Record</a></b>
                     </center>
                </div>
