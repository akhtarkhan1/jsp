    ...
    <body>
           <%@ include file="otherservicemenuadmin.jsp" %>
            ...
            <center>
                ...
                <form action="ctocmoDao.jsp" method="POST" onsubmit="return validate7();"></br></br>
                    <div align="center">
    	...
    	<input type="reset" value="Clear">               
                    ...
                    <br><br><br>
        <center>
            <b><a href="updatectocmo.jsp">Update Record</a></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b><a href="deletectocmo.jsp">Delete Record</a></b>
        </center>
                </div>
