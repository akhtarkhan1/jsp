    ...
    <body>
           <%@ include file="otherservicemenuadmin.jsp" %>
            ...
            <center>
                ...
                <form action="rewardDao.jsp" method="POST" onsubmit="return validate7();"></br></br>
                    <div align="center">
    	...
    	<input type="reset" value="Clear">               
                    ...
                    <a href="promotion.jsp"><img src="images\v11.png" border="0" alt="" width="80" height="40"  align="right"/></a>
                    <br><br><br>
        <center>
            <b><a href="updatereward.jsp">Update Record</a></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b><a href="deletereward.jsp">Delete Record</a></b>
        </center>
                </div>
